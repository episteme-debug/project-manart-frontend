$(document).ready(function (params) {
  ...
  function crearHTMLProducto(producto) {
    ...
    const precioViejoProducto = (
      producto.precioProducto -
      producto.precioProducto * porcentajeDescuento
    ).toFixed(2);
            ...
            <li class="scrollbar-item-producto">
                <div class="compra-card">
                    <div class="card-banner img-holder">
                        <img class="img-cover" loading="lazy" src="${
                    ...
                    <div class="card-contenido">
                        <div class="precio">
                            ...
                            <del class="del">$${producto.precioProducto.toFixed(
                              2
                            )}</del>
                        </div>
                        <h3>
                        ...
                        <div class="card-valuacion">
                            <div class="valuacion-contenedor">
                                ${'<img src="iconos/star.svg" alt="" class="ion-icon">'.repeat(
                                  5
                                )}
                            </div>
